...
const DICT = {
  zh: {
    ...
    'models.import.hint': '将 .pth / .index / .onnx 文件或其 zip 压缩包拖入此处。文件只保存在你的浏览器 IndexedDB 中，不会上传。',
  ...
  en: {
    ...
    'models.import.hint': 'Drop .pth / .index / .onnx files or a zip archive. Everything stays in your browser IndexedDB — nothing is uploaded.',
