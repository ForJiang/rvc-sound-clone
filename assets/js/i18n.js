...
const DICT = {
  zh: {
    ...
    'convert.rec.busy': '麦克风被其他程序占用，请关掉其他使用麦克风的程序后重试。',
    'convert.rec.failed': '录音启动失败',
    'convert.rec.limit': '已达到最长录制时长（{sec} 秒），已自动停止。',
    'convert.rec.requesting': '正在请求麦克风权限…',
    ...
    'settings.appearance.theme.fixed': '固定深色：WebGL RGB 正弦波背景 + 玻璃面板。',
  ...
  en: {
    ...
    'convert.rec.busy': 'The microphone is in use by another app. Close it and retry.',
    'convert.rec.failed': 'Could not start recording',
    'convert.rec.limit': 'Maximum length reached ({sec}s) — recording stopped automatically.',
    'convert.rec.requesting': 'Requesting microphone access…',
    ...
    'settings.appearance.theme.fixed': 'Dark only: WebGL RGB sine-wave background with glass panels.',
