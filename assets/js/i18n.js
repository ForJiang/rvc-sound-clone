...
const DICT = {
  zh: {
    ...
    'settings.appearance.theme.fixed': '固定深色：液态金属背景 + 玻璃面板（与 Image Metadata Cleaner 同一套视觉语言）。',
  ...
  en: {
    ...
    'settings.appearance.theme.fixed': 'Dark only: liquid-metal background with glass panels (same visual language as Image Metadata Cleaner).',
